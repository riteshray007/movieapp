...
export class TopRated extends Component {
  ...
  async componentDidMount() {
    const res = await axios.get(
      `https://api.themoviedb.org/3/movie/top_rated?api_key=588cdf9715348dda0561ce854dcbc4ac&language=en-US&page=${this.state.currpage} `
    );
    ...
    return (
      <>
        ...
        <div class="glitch-wrapper trending  ">
          <div class="glitch" data-glitch="TopRated">  TopRated </div>
        </div>
